...
from Common.multiprocess_JT import XboxJoystic
...
def main(id, command_status):
    ...
    while True:
        ...
        if result_dict['StartStepping']: # error happened
...
if __name__ == "__main__":
    try:
        KeyTest = XboxJoystic()
        KeyProcess = Process(target=KeyTest.XboxJoystic, args=(1, KeyTest.key_status, KeyTest.command_status))

        KeyProcess.start()
         # Main Process 
        main(2, KeyTest.command_status)
